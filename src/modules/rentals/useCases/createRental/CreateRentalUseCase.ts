...
export class CreateRentalUseCase {
  ...
  async execute({
    ...
    const compareReturnDate = this.dateProvider.compareInHours(dateNow, expected_return_date);
    if (compareReturnDate < minHoursRental) throw new AppError("Invalid Return Time");
